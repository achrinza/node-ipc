...
npm info :  [See npm trends and stats for @achrinza/node-ipc](http://npm-stat.com/charts.html?package=@achrinza/node-ipc&author=&from=&to=)   
[![NPM](https://nodei.co/npm/@achrinza/node-ipc.png?downloads=true&downloadRank=true&stars=true)](https://nodei.co/npm/@achrinza/node-ipc/)
[![Package Quality](http://npm.packagequality.com/badge/@achrinza/node-ipc.png)](http://packagequality.com/#?package=@achrinza/node-ipc)  
![@achrinza/node-ipc npm version](https://img.shields.io/npm/v/@achrinza/node-ipc.svg) ![supported node version for @achrinza/node-ipc](https://img.shields.io/node/v/@achrinza/node-ipc.svg) ![total npm downloads for @achrinza/node-ipc](https://img.shields.io/npm/dt/@achrinza/node-ipc.svg) ![monthly npm downloads for @achrinza/node-ipc](https://img.shields.io/npm/dm/@achrinza/node-ipc.svg) ![npm licence for @achrinza/node-ipc](https://img.shields.io/npm/l/@achrinza/node-ipc.svg)

[![RIAEvangelist](https://avatars3.githubusercontent.com/u/369041?v=3&s=100)](https://github.com/RIAEvangelist)

GitHub info :  
![@achrinza/node-ipc GitHub Release](https://img.shields.io/github/release/RIAEvangelist/@achrinza/node-ipc.svg) ![GitHub license @achrinza/node-ipc license](https://img.shields.io/github/license/RIAEvangelist/@achrinza/node-ipc.svg) ![open issues for @achrinza/node-ipc on GitHub](https://img.shields.io/github/issues/RIAEvangelist/@achrinza/node-ipc.svg)

Codacy info :  
[![Codacy Badge](https://api.codacy.com/project/badge/grade/8e0294dff55f4ac1985c07b16f39d0a9)](https://www.codacy.com/app/RIAEvangelist/@achrinza/node-ipc) [![Codacy Badge](https://api.codacy.com/project/badge/coverage/8e0294dff55f4ac1985c07b16f39d0a9)](https://www.codacy.com/app/RIAEvangelist/@achrinza/node-ipc)

Build Info :  
Mac & Linux : [![Build Status](https://travis-ci.org/RIAEvangelist/@achrinza/node-ipc.svg?branch=master)](https://travis-ci.org/RIAEvangelist/@achrinza/node-ipc) Windows : [![@achrinza/node-ipc windows build status](https://ci.appveyor.com/api/projects/status/github/riaevangelist/@achrinza/node-ipc?branch=master&svg=true)](https://ci.appveyor.com/project/RIAEvangelist/@achrinza/node-ipc/history)

Package details websites :
* [GitHub.io site](http://riaevangelist.github.io/@achrinza/node-ipc/ "@achrinza/node-ipc documentation"). A prettier version of this site.
* [NPM Module](https://www.npmjs.org/package/@achrinza/node-ipc "@achrinza/node-ipc npm module"). The npm page for the @achrinza/node-ipc module.
...
7. [Working with TLS/SSL Socket Servers & Clients](https://github.com/RIAEvangelist/@achrinza/node-ipc/tree/master/example/TLSSocket)
8. [Node Code Examples](https://github.com/RIAEvangelist/@achrinza/node-ipc/tree/master/example)
